        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
             ...
             <!--  <input type="button" data-toggle="modal" data-target="#alert" name="upload" value="Simpan Bukti" class="btn btn-primary"> -->
            </div>
          </div>
          </form>
        </div>
    ...
    <!-- <div class="modal fade" id="alert">
                    <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-header">
                            ...
                            <h3><strong>Upload Bukti Berhasil</strong></h3>
                            <p><center><font color="green" size="4px"><b><?= $this->session->flashdata('pesan');?></b></font></center></p>
                        </div>
                         <form action="<?=base_url('user_home/upload_bukti')?>" method="post" class="form-horizontal form-label-left">
                                    <div class="modal-footer">
                                        <button type="submit" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                                        <input type="submit" name="upload" value="Oke" class="btn btn-primary">
                                    </div></form>
                                    </div>
