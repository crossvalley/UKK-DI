...
<div class="register-box">
  <div class="register-logo">
    <a href="<?=base_url()?>user/register"><b>Pembayaran</b> Listrik</a>
  </div>
  ...
  <div class="register-box-body">
    ...
    <form action="<?=base_url('user/register_akun')?>" method="post">
      <div class="form-group has-feedback">
        <input type="text" name="nama_pelanggan" class="form-control" placeholder="Nama" required="required">
      ...
      <div class="form-group has-feedback">
        <input type="number" name="nomor_kwh" class="form-control" placeholder="Nomor Kwh" required="required">
